...
urlpatterns = [
    ...
    path('questionnaires/questionnaires_prives', views.questionnaires_prives, name='questionnaires_prives'),
    path('questionnaires/questionnaires_publics', views.questionnaires_publics, name='questionnaires_publics'),
