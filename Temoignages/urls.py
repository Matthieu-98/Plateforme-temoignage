...
urlpatterns = [
    ...
    path('questionnaires/questionnaires_prives.html', views.questionnaires_prives, name='questionnaires_prives'),
    path('questionnaires/questionnaires_publics.html', views.questionnaires_publics, name='questionnaires_publics'),
